module.exports = [
"[project]/service/api.client.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/constants/api.routes.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/service/packages/packages.service.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/service/api.client.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/constants/api.routes.js [app-ssr] (ecmascript)");
;
;
const getPartnerPackages = ({ partnerId, page = 1, limit = 10 })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ROUTES"].PACKAGES.PACKAGE_LIST}?partnerId=${partnerId}&page=${page}&limit=${limit}`, {
        method: "GET"
    });
const getAllPackages = ({ page = 1, limit = 10 })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ROUTES"].PACKAGES.PACKAGE_LIST_USER}?page=${page}&limit=${limit}`, {
        method: "GET"
    });
const createPackage = (payload)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"])(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ROUTES"].PACKAGES.CREATE_PACKAGE, {
        method: "POST",
        body: payload
    });
}),
"[project]/service/packages/packages.queries.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/service/packages/packages.service.js [app-ssr] (ecmascript)");
"use client";
;
;
const useGetPartnerPackages = ({ partnerId, page, limit })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "partner-packages",
            partnerId,
            page,
        ...
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getPartnerPackages"]({
                partnerId,
                page,
                limit
            }),
...
const useGetAllPackages = ({ page, limit })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "all-packages",
            page,
            limit
        ],
        queryFn: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAllPackages"]({
                page,
                limit
            }),
        keepPreviousData: true
...
const useCreatePackage = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$service$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createPackage"],
        onSuccess: ()=>{
...
"[project]/components/TopNavBar/TopNavBar.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/Sidebar/Sidebar.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/index.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TopNavBar$2f$TopNavBar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/TopNavBar/TopNavBar.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Sidebar$2f$Sidebar$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/Sidebar/Sidebar.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SidebarNew$2f$SidebarNew$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SidebarNew/SidebarNew.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2f$DataTable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DataTable/DataTable.js [app-ssr] (ecmascript)");
;
;
;
;
...
"[project]/components/DataTable/DataTable.js [app-ssr] (ecmascript) <export default as DataTable>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DataTable",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2f$DataTable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2f$DataTable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DataTable/DataTable.js [app-ssr] (ecmascript)");
}),
"[project]/app/packages/user/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$queries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/service/packages/packages.queries.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/components/index.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2f$DataTable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__DataTable$3e$__ = __turbopack_context__.i("[project]/components/DataTable/DataTable.js [app-ssr] (ecmascript) <export default as DataTable>");
"use client";
;
;
;
...
function AvailablePackagesPage() {
    ...
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$packages$2f$packages$2e$queries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGetAllPackages"])({
        page,
        limit
    });
    ...
    const columns = [
        ...
        },
        {
            accessorKey: "actions",
            header: "Book Now",
            cell: ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                    href: `${__TURBOPACK__imported__module__$5b$project$5d2f$navigation$2f$page$2e$navigation$2e$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PAGE_ROUTES"].USER_PAGES.BOOKING}/${row.original.id}`,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DataTable$2f$DataTable$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__DataTable$3e$__["DataTable"], {
                    columns: columns,
                    data: packages,
...
//# sourceMappingURL=_a4d4358e._.js.map