...
"[project]/service/bookings/bookings.service.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const getUserBookings = ({ userId, page = 1, limit = 10 })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ROUTES"].BOOKINGS.USER_BOOKINGS}?userId=${userId}&page=${page}&limit=${limit}`, {
        method: "GET"
    });
const getPartnerBookings = ({ page = 1, limit = 10 })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(`${__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ROUTES"].BOOKINGS.PARTNER_BOOKINGS_LIST}?page=${page}&limit=${limit}`, {
        method: "GET"
    });
const createBooking = (payload)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$api$2e$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$api$2e$routes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ROUTES"].BOOKINGS.CREATE_BOOKING, {
        method: "POST",
        body: payload
    });
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/service/bookings/bookings.queries.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "useCreateBooking",
    ()=>useCreateBooking,
    "useGetPartnerBookings",
    ()=>useGetPartnerBookings,
    "useGetUserBookings",
    ()=>useGetUserBookings
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/service/bookings/bookings.service.js [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature(), _s2 = __turbopack_context__.k.signature();
"use client";
;
;
const useGetUserBookings = ({ page = 1, limit = 10 })=>{
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useGetUserBookings.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserBookings"]({
                    page,
                    limit
                })
        }["useGetUserBookings.useQuery"],
        keepPreviousData: true
    });
};
_s(useGetUserBookings, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
const useGetPartnerBookings = ({ page = 1, limit = 10 })=>{
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "partner-bookings",
        ...
        queryFn: {
            "useGetPartnerBookings.useQuery": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPartnerBookings"]({
                    page,
                    limit
                })
        }["useGetPartnerBookings.useQuery"],
        keepPreviousData: true
    });
};
_s1(useGetPartnerBookings, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
const useCreateBooking = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$service$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBooking"],
        onSuccess: {
...
"[project]/app/activity-management/partner/bookings/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$queries$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/service/bookings/bookings.queries.js [app-client] (ecmascript)");
;
...
function PartnerBookingsPage() {
    ...
    // Fetch bookings
    const { data, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$queries$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPartnerBookings"])({
        page,
        limit
    });
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PartnerBookingsPage.useMemo[columns]": ()=>[
                {
                    accessorKey: "id",
                    header: "ID"
                },
                {
                    ...
                    header: "Customer",
                    cell: {
                        "PartnerBookingsPage.useMemo[columns]": ({ row })=>row.original.user?.name || "-"
                    }["PartnerBookingsPage.useMemo[columns]"]
                },
                {
                    ...
                    header: "Package",
                    cell: {
                        "PartnerBookingsPage.useMemo[columns]": ({ row })=>row.original.package?.name || "-"
                    }["PartnerBookingsPage.useMemo[columns]"]
                },
                {
                    ...
                    header: "Booking Date",
                    cell: {
                        "PartnerBookingsPage.useMemo[columns]": ({ row })=>new Date(row.original.bookingDate).toLocaleDateString()
                    }["PartnerBookingsPage.useMemo[columns]"]
                },
                {
                    ...
                    header: "Status",
                    cell: {
                        "PartnerBookingsPage.useMemo[columns]": ({ row })=>row.original.status?.name || "-"
                    }["PartnerBookingsPage.useMemo[columns]"]
                },
                {
                    id: "actions",
                    header: "Actions",
                    cell: {
                        "PartnerBookingsPage.useMemo[columns]": ({ row })=>{
                            const status = row.original.status?.name;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex gap-2",
                                children: status === "Pending" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            className: "px-3 py-1 text-sm bg-green-600 text-white rounded hover:bg-green-700",
                                            children: "Confirm"
                                        }, void 0, false, {
                                            fileName: "[project]/app/activity-management/partner/bookings/page.js",
                                            lineNumber: 58,
                                            columnNumber: 19
                                        }, this),
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(PartnerBookingsPage, "5c3o1zLxlTrTQukWL5wAvuyxG0E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$service$2f$bookings$2f$bookings$2e$queries$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPartnerBookings"]
    ];
});
_c = PartnerBookingsPage;
var _c;
__turbopack_context__.k.register(_c, "PartnerBookingsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a3186f6c._.js.map